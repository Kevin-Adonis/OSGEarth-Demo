...
#include "map_gr/map_gr_createcompass.h"
...
public:
    ...
    /**
     * @brief drawingPrimitive
     * 控制调度绘制图元，本身不参与绘制。
     */
    void drawingPrimitive();

    /**
     * @brief showLatLongGrid
     * 控制切换显示经纬网络
     */
    void showLatLongGrid();
     ...
     * 显示位置纵坐标
     */
    void showCompass(double x, double y);
...
private:
    ...
    MAP_GR_CreateCompass *m_pCompass;
};
