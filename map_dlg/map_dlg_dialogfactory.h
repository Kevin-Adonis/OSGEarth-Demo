...
public:
    ...
    /**
     * @brief createConfigDialog
     * 生成一系列图元绘制参数配置界面，
     * 区别设置参考PrimitiveConfigDialog类的头文件
     * @see
     * map_dlg/map_dlg_primitiveconfigdialog.h
     * @param parent
     * @return
     */
    MAP_DLG_TemplateDialog* createConfigDialog(QWidget *parent=nullptr);
