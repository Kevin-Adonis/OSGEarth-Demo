...
MAP_DLG_TemplateDialog *MAP_DLG_TemplateDialogFactory::createConfigDialog(QWidget *parent)
{
    MAP_DLG_TemplateDialog *dialog =  new MAP_DLG_PrimitiveConfigDialog(parent);
    return dialog;
}
