...
MAP_CONTROLLER_PrimitiveConfigController *MAP_GLOBALDATA_Controller::primitiveConfigController =
        new MAP_CONTROLLER_PrimitiveConfigController();
MAP_CONTROLLER_CanvasToolController *MAP_GLOBALDATA_Controller::canvasToolController =
        new MAP_CONTROLLER_CanvasToolController();
MAP_CONTROLLER_SVGController *MAP_GLOBALDATA_Controller::svgController =
        new MAP_CONTROLLER_SVGController();
